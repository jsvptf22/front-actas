(function($) {
                ...
                function() {
                    ...
                    if ($(this).val()) {
                        $(this)
                            .closest('.form-group')
                            .find('label')
                            .not('.label-without-focus')
                            .addClass('fade');
                    } else {
                        $(this)
                            .closest('.form-group')
                            .find('label')
                            .not('.label-without-focus,.autocomplete')
                            .removeClass('fade');
                    }
                }
            );
    ...
    Pages.prototype.initHorizontalMenu = function() {
        ...
        $('[data-toggle="horizontal-menu"]').on('click touchstart', function(
            e
        ) {
            e.preventDefault();
...
(function($) {
    ...
    var Quickview = function(element, options) {
        ...
        $(this.options.notes).on('click', '.list > ul > li .checkbox', function(
            e
        ) {
            e.stopPropagation();
        });
        $(this.options.notes).on('click', _this.options.backButton, function(
            e
        ) {
            $(_this.options.notes)
                .find('.toolbar > li > a')
